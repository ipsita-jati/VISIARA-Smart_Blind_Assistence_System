...
def analyze_stairs(stair_crop):
    ...
    try:
        ...
        if lines is not None:
            ...
            # Final step estimation
            step_count = round(len(filtered_y) / 2)
...
BOTTOM_REGION = 0.50
# TTC SETTINGS
FAST_APPROACH_THRESHOLD = 1.80
MEDIUM_APPROACH_THRESHOLD = 1.40
    ...
    for results, model in [
        ...
        for r in results:
            ...
            for box in r.boxes:
                ...
                # But always allow traffic light, close door, stair, steps
                if (
                    cy < h * 0.50
                    and name not in [
                        "traffic light",
